...
var DbHelper = /** @class */ (function () {
     ...
     */
    DbHelper.createAndSetConfig = function (config) {
     ...
     */
    DbHelper.createConnection = function (config) {
     ...
     * @param config The configuration to use for connection.
     */
    DbHelper.createDocClient = function (config) {
        DbHelper.createAndSetConfig(config);
     ...
     * @param config The configuration to use for connection.
     */
    DbHelper.listTables = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var dbConnection, res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dbConnection = DbHelper.createConnection(config);
                        return [4 /*yield*/, dbConnection.listTables().promise()];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, res.TableNames];
                }
            });
        });
    };
