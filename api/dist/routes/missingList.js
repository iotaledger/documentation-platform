 ...
 */
function missingList(config, request) {
    return __awaiter(this, void 0, void 0, function () {
        var missingService, all, items, _i, all_1, mising, _a, _b, fromDocument, _c, _d, fromDocument, head, body, tc, _e, items_1, item, foot;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    return [4 /*yield*/, missingService.getAll()];
                case 1:
                    all = _f.sent();
                    items = [];
                    for (_i = 0, all_1 = all; _i < all_1.length; _i++) {
                        ...
                        if (mising.fromDocument) {
                            for (_a = 0, _b = mising.fromDocument; _a < _b.length; _a++) {
                                fromDocument = _b[_a];
                                items.push({
                        ...
                        if (mising.fromDocumentTime) {
                            for (_c = 0, _d = mising.fromDocumentTime; _c < _d.length; _c++) {
                                fromDocument = _d[_c];
                                items.push({
                                    document: mising.document,
                    ...
                    head = "<html><head><title>Missing</title><link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/css/bootstrap.min.css\" integrity=\"sha384-r4NyP46KrjDleawBgD5tp8Y7UzmLA05oM1iAEQ17CSuDqnUK2+k9luXQOfXJCJ4I\" crossorigin=\"anonymous\"></head><body>";
                    body = "<div class=\"m-4\"><table class=\"table table-striped\"><thead><tr><th>Date</th><th>Document</th><th>Referenced From</th></tr></thead><tbody>";
                    tc = "";
                    for (_e = 0, items_1 = items; _e < items_1.length; _e++) {
                        item = items_1[_e];
