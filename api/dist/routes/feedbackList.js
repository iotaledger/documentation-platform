 ...
 */
function feedbackList(config, request) {
    return __awaiter(this, void 0, void 0, function () {
        var feedbackService, all, items, _i, all_1, feedback, _a, _b, entry, head, body, tc, _c, items_1, item, foot;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    feedbackService = new feedbackService_1.FeedbackService(config.dynamoDbConnection);
                    return [4 /*yield*/, feedbackService.getAll()];
                case 1:
                    all = _d.sent();
                    items = [];
                    for (_i = 0, all_1 = all; _i < all_1.length; _i++) {
                        feedback = all_1[_i];
                        for (_a = 0, _b = feedback.entries; _a < _b.length; _a++) {
                            entry = _b[_a];
                            items.push({
                    ...
                    head = "<html><head><title>Feedback</title><link rel=\"stylesheet\" href=\"https://stackpath.bootstrapcdn.com/bootstrap/5.0.0-alpha1/css/bootstrap.min.css\" integrity=\"sha384-r4NyP46KrjDleawBgD5tp8Y7UzmLA05oM1iAEQ17CSuDqnUK2+k9luXQOfXJCJ4I\" crossorigin=\"anonymous\"></head><body>";
                    body = "<div class=\"m-4\"><table class=\"table table-striped\"><thead><tr><th>Date</th><th>Document</th><th>Useful?</th><th>Comments</th></tr></thead><tbody>";
                    tc = "";
