...
function missingCreate(config, request) {
    return __awaiter(this, void 0, void 0, function () {
        var missingService, docName, documentMissing, current;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, missingService.get(docName)];
                case 1:
                    ...
                    request.fromDocument = validationHelper_1.ValidationHelper.stripHtml(request.fromDocument);
                    current = documentMissing.fromDocumentTime.find(function (f) { return f.document === request.fromDocument; });
                    if (current) {
